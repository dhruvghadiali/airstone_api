...
/**
 * The body an admin sends to create an employee.
 *
 * The same five fields as `admin_signup_schema`, kept as its own file so the
 ...
 */
const employee_signup_schema = joi
  .object({
    first_name,
    last_name,
    email,
...
module.exports = employee_signup_schema;
