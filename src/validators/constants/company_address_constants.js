 ...
 *
 * `CONTACT_PERSON_LIST_MIN_ITEMS` is about the `contact_person` array the create
 * endpoint takes. An address nobody can be reached at is of no use, so one
 * contact is the floor.
 *
...
const company_address_validation_limits = Object.freeze({
  CONTACT_PERSON_LIST_MIN_ITEMS: 1,
  ADDRESS_MIN: 3,
  ADDRESS_MAX: 500,
  PINCODE_LENGTH: 6,
});
